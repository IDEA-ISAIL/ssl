...
# import torch
# import numpy as np
from .locality import knn_local
from .globality import cluster_global
class NeighborSearch_AFGRL(Augmentor):
    ...
    def __call__(self, adj, student, teacher, top_k):
        ...
        locality, I_knn = knn_local(adj, student, teacher, top_k, self.device)
        ...
        globality = cluster_global(teacher, I_knn, self.num_centroids, self.clus_num_iters, self.num_kmeans, self.device)
