...
from augment import AugPosDGI, AugNegDGI, RandomMask, RandomDropEdge, RandomDropNode, AugmentSubgraph
...
if aug_type == 'edge':
    ...
    assert False
augment_pos = augment_neg

GraphCL = GraphCL(model=model, data_loader=data_loader, augment_pos=augment_pos, augment_neg=augment_neg,
